...
def download_pdf(filters=None):
    ...
    template_path = os.path.join(
        frappe.get_app_path('akfa_accounting2'),
        'akfa_accounting2', 'report', 'akt_sverka', 'akt_sverka_pdf.html'
    )
...
def get_summary_html(data, filters):
    ...
    # Nachisleniya (Accruals) - Journal Entry
